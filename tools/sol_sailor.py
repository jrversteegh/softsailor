...
while sailor.sail():
    ...
    print "  Bearing     : ", u"%10.2f\u00B0" % rad_to_deg(bearing[0])
    ...
    print "Boat latitude : ", u"%10.4f\u00B0N" % rad_to_deg(boat.position[0])
    print "Boat longitude: ", u"%10.4f\u00B0E" % rad_to_deg(boat.position[1])
    print "Boat heading  : ", u"%10.2f\u00B0" % rad_to_deg(boat.heading)
    print "Boat course   : ", u"%10.2f\u00B0" % rad_to_deg(boat.motion.course)
    print "Boat speed    : ", "%10.2f kn" % ms_to_kn(boat.speed)
    print "Wind direction: ", u"%10.2f\u00B0" % rad_to_deg(boat.condition.wind[0])
    print "Wind angle    : ", u"%10.2f\u00B0" % rad_to_deg(boat.wind_angle)
    print "Wind speed    : ", "%10.2f kn" % ms_to_kn(boat.condition.wind[1])
    print "Apparent angle: ", u"%10.2f\u00B0" % rad_to_deg(boat.apparent_wind.sa)
